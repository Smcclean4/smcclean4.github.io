    ...
    <Layout>
      <div className={loading ? "w-3/4 lg:w-2/4 h-3/4 flex flex-col animate-fadingRev" : "w-3/4 lg:w-2/4 h-3/4 flex flex-col"}>
        <div className="flex flex-row items-end">
          ...
          <div>
            <p className={loading ? "text-2xl sm:text-3xl font-mono animate-extension1 mb-2 text-white" : "text-2xl sm:text-3xl font-mono mb-2 text-white"}>This is <Link href="/projects/foodlux"><b className="underline"><i>Foodlux</i></b></Link>.</p>
