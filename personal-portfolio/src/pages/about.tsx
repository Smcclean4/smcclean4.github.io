      ...
      <div className="flex flex-col-reverse h-full w-full text-center lg:flex-row text-white">
        <div className="w-full flex flex-col justify-center items-center lg:w-1/2">
          ...
          <div className="w-11/12 text-xl font-extralight sm:w-3/4">
            ...
            <p className="my-2">
              My extensive range of skills and experience as a developer makes me a versatile fit for various positions. I have honed my proficiency in multiple programming languages, including but not limited to <i className="underline"><b>JavaScript/TypeScript, Node.js</b></i>, and adeptly employ a variety of frameworks and tools such as <i className="underline"><b>React.js/Next.js and Express.js</b></i>. Furthermore, my expertise extends to databases, with proficiency in both <i className="underline"><b>SQL and NoSQL</b></i> databases.
            </p>
            <p className="my-2">
