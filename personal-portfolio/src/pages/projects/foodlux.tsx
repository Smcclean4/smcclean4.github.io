    ...
    <Layout>
      <div className="flex flex-col lg:flex-row w-full h-full lg:bg-gradient-to-br from-black from-50% to-white to-50%">
        ...
        <div className="text-black w-full lg:w-1/2 h-full flex flex-col items-center justify-end lg:bg-inherit bg-white">
          ...
          <p className="font-mono text-md md:text-xl my-4 px-6 text-center">You can find this project live <a target="_blank" href="https://www.sidneylmcclean.dev/foodlux/Login" className="underline">here</a>. And the source code <a target="_blank" href="https://www.github.com/smcclean4/foodlux" className="underline">here</a>.</p>
        </div>
      </div>
    </Layout>
  )
